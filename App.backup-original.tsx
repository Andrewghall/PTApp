            ...
            <View style={{position: 'relative'}}>
              ...
              >
                <Svg width={22} height={22} viewBox="0 0 24 24" fill="none">
                  {showPassword ? (
                    <>
                      <Path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8S1 12 1 12z" stroke="#9ca3af" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                    ...
                    <>
                      ...
                      <Path d="M14.12 14.12a3 3 0 1 1-4.24-4.24" stroke="#9ca3af" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
...
const BookingScreen = ({ bookedSessions, onBookSession, creditBalance }: { bookedSessions: any[], onBookSession: (slotId: string) => Promise<void>, creditBalance: number }) => {
  ...
  const isSlotAvailable = (day: number, slot: string) => {
    ...
    // For now, assume slot is available if not booked and user has credits
    return true;
  };
